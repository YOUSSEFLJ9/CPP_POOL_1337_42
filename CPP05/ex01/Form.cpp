...
/*   Updated: 2024/11/23 18:17:06 by ymomen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Form.hpp"

Form :: Form(): name("Form"), sign(false), rq_grade_sign(75), rq_grade_exc(75)
{
    std::cout <<GREEN "Form default constructor called" REST<<std::endl;
}
...
{
    std::cout <<GREEN "Form parameterized constructor called" REST<< std::endl;
}
Form::Form(const Form &other):  name(other.name),rq_grade_sign(other.rq_grade_sign), rq_grade_exc(other.rq_grade_exc)
{
    std::cout <<GREEN "Form copy constructor called" REST<<std::endl;
    *this = other;
}
Form &Form::operator=(const Form &other)
{
    std::cout <<GREEN "Form copy assignment operator called" REST<< std::endl;
    if (&other != this)
    {
...
Form::~Form()
{
    std :: cout <<GREEN "Form destructor called" REST<<std ::endl;
}
